...
namespace ECommerceWebsite.Migrations
{
    ...
    [Migration("20251005210131_AddContactMessagesTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ECommerceWebsite.Models.ShippingMethod", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            UpdatedAt = new DateTime(2025, 10, 6, 0, 1, 29, 98, DateTimeKind.Local).AddTicks(9597)
                        },
                        new
                        {
                            Id = 2,
                            ...
                            UpdatedAt = new DateTime(2025, 10, 6, 0, 1, 29, 99, DateTimeKind.Local).AddTicks(1786)
                        },
                        new
                        {
                            Id = 3,
                            ...
                            UpdatedAt = new DateTime(2025, 10, 6, 0, 1, 29, 99, DateTimeKind.Local).AddTicks(1799)
                        },
                        new
                        {
                            Id = 4,
                            ...
                            IsActive = true,
                            Name = "Free Shipping",
                            UpdatedAt = new DateTime(2025, 10, 6, 0, 1, 29, 99, DateTimeKind.Local).AddTicks(1815)
                        });
                });

            modelBuilder.Entity("ECommerceWebsite.Models.TaxSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Region = "Cairo",
                            TaxRate = 14.00m,
                            UpdatedAt = new DateTime(2025, 10, 6, 0, 1, 29, 99, DateTimeKind.Local).AddTicks(3354)
                        },
                        new
                        {
                            Id = 2,
                            ...
                            Region = "Alexandria",
                            TaxRate = 14.00m,
                            UpdatedAt = new DateTime(2025, 10, 6, 0, 1, 29, 99, DateTimeKind.Local).AddTicks(6221)
                        },
                        new
                        {
                            Id = 3,
                            ...
                            Region = "Riyadh",
                            TaxRate = 15.00m,
                            UpdatedAt = new DateTime(2025, 10, 6, 0, 1, 29, 99, DateTimeKind.Local).AddTicks(6229)
                        },
                        new
                        {
                            Id = 4,
                            ...
                            Region = "Dubai",
                            TaxRate = 5.00m,
                            UpdatedAt = new DateTime(2025, 10, 6, 0, 1, 29, 99, DateTimeKind.Local).AddTicks(6238)
                        });
                });
            ...
            modelBuilder.Entity("ECommerceWebsite.Models.Order", b =>
                {
                    ...
                    b.HasOne("ECommerceWebsite.Models.ShippingMethod", "SelectedShippingMethod")
                        .WithMany()
                        .HasForeignKey("ShippingMethodId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("ECommerceWebsite.Models.TaxSetting", "AppliedTaxSetting")
                        .WithMany()
                    ...
                    b.Navigation("AppliedTaxSetting");

                    b.Navigation("Coupon");

                    b.Navigation("SelectedShippingMethod");
